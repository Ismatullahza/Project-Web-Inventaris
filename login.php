...
<head>
    ...
    <title>INVENTARIS PT. JAVA MEDIANET TEKHNOLOGY</title>

    <!-- images -->
    <link rel="icon" type="images/jpg" href="<?=$base_url;?>assets/img/images.jpg">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block text-center my-auto">
                                <img src="<?=$base_url;?>assets/img/logo-30032023.png" class="login-image">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p> PT. Java Medianet Tekhnology</p>
                                    </div>
